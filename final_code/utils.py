...
def minimize_mask(bbox, mask, mini_shape):
    ...
    """
    instance_index_array = np.ones(mask.shape[-1])
    ...
    for i in range(mask.shape[-1]):
        ...
        if m.size == 0:
            instance_index_array[i] = 0  # change from 1 to 0 if the instance disappears
            
            print("========================utlis.py line 457 debug===================")
            print(i)
            print(instance_index_array)
            """
            print("scale: ", scale)
    ...
    return mini_mask, instance_index_array
